...
export default function WhatsAppButton() {
  ...
  return (
    /* Positioned bottom-left, above the mobile nav safe area */
    <div
    ...
    >
      ...
      <AnimatePresence>
        {showTooltip && !dismissed && (
          <motion.div
            ...
            className="relative flex items-start gap-2 bg-white rounded-2xl shadow-xl border border-green-100 px-3 py-2.5 max-w-[180px] sm:max-w-[200px]"
          >
      ...
      <motion.button
        ...
        className="w-13 h-13 sm:w-14 sm:h-14 rounded-full shadow-2xl flex items-center justify-center relative"
        style={{
          width: '52px',
          height: '52px',
